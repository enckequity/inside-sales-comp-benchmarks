...
## A · Commission rate per deal — % of front-end gross profit  *(the anchor)*
...
## B · Cost of sale — sales pay as % of sales / expense  *(store-level KPI)*
...
## C · Top-producer earnings  *(market context)*
...
## General cross-check (not dealer-specific — label as such)
...
## Pine Hill internal inputs (ours — not externally cited)
